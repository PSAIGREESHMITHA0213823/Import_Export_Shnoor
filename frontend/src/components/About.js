...
const leadership = [
  {
    name: "Rajesh Mehta",
    title: "CEO & Founder",
    desc: "Former trade consultant with 20+ years in global logistics, leading TradeLint's vision to democratize trade intelligence.",
    img: "https://randomuser.me/api/portraits/men/32.jpg"
  },
  {
    name: "Priya Sharma",
    title: "CTO",
    desc: "AI and ML expert who built TradeLint's core classification engine, previously led engineering at a leading fintech.",
    img: "https://randomuser.me/api/portraits/women/68.jpg"
  },
  {
    name: "Amit Patel",
    title: "Head of Operations",
    desc: "Supply chain specialist ensuring seamless onboarding and 24/7 support for our enterprise clients worldwide.",
...
function About() {
  ...
  return (
    <div style={{ paddingTop: 80, background: "#0D1E38" }}>
      ...
      {/* Leadership Section */}
      {/* <section ref={leadershipRef} style={{ background: "#0A1628", padding: "90px 5%" }}>
        <div style={{ maxWidth: 1240, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 56, ...reveal(leadershipVisible) }}>
            <div style={{ 
              display: "inline-flex", 
              gap: 8, 
              alignItems: "center", 
            ...
            <p style={{ fontSize: 16, color: "rgba(255,255,255,0.6)", maxWidth: 560, margin: "0 auto", lineHeight: 1.8 }}>
              Experts in trade, technology, and AI — united to transform global commerce.
            </p>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(320px,1fr))", gap: 32 }}>
            {leadership.map((leader, i) => (
              <div 
                key={i} 
                style={{ 
                  ...reveal(leadershipVisible, i * 0.1), 
                  background: "rgba(255,255,255,0.05)", 
                  border: "1px solid rgba(255,255,255,0.1)", 
                  borderRadius: 20, 
                  overflow: "hidden",
                ...
                onMouseEnter={e => { e.currentTarget.style.transform = "translateY(-8px)"; e.currentTarget.style.borderColor = "#E8A020"; }}
                onMouseLeave={e => { e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.borderColor = "rgba(255,255,255,0.1)"; }}
              >
                ...
                <div style={{ padding: "24px 28px 32px" }}>
                  <h3 style={{ fontSize: 20, fontWeight: 700, color: "#FFF", marginBottom: 4 }}>{leader.name}</h3>
                  <div style={{ fontSize: 12, color: "#E8A020", fontWeight: 600, marginBottom: 12 }}>{leader.title}</div>
                  <p style={{ fontSize: 14, color: "rgba(255,255,255,0.6)", lineHeight: 1.7 }}>{leader.desc}</p>
                </div>
              </div>
            ))}
          </div>
