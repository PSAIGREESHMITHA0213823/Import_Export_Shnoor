...
//       <Card title="Document OCR Upload" sub="AI extracts invoice data with high accuracy">
//         {/* Drop zone */}
//         <div
...
//               <p className="text-sm font-medium text-gray-600">Processing document…</p>
//               <p className="text-xs text-gray-400">Extracting data with OCR</p>
//             </div>
//           ) : (
//             <>
//               <p className="text-4xl mb-3">📄</p>
//               <p className="font-semibold text-gray-700 mb-1">Drop files here or click to browse</p>
//               <p className="text-xs text-gray-400">PDF, PNG, JPG, XLSX, CSV — max 10MB</p>
//             </>
//           )}
//         </div>
...
//             <ResultItem label="Document ID" value={result.document_id} small />
//             <ResultItem label="Filename" value={result.filename} small />
//             <ResultItem label="Invoice Number" value={result.extracted_data.invoice_number} />
//             <ResultItem label="Invoice Date" value={result.extracted_data.date} />
//             <ResultItem label="Total Amount" value={`$${fmt(result.extracted_data.total_amount)}`} accent />
//             <ResultItem label="Currency" value={result.extracted_data.currency} />
//           </div>

//           <div className="mt-5 pt-5 border-t border-gray-100 bg-gray-50 rounded-xl p-4">
//             <p className="text-xs font-medium text-gray-500 mb-2">Raw extracted data (JSON)</p>
...
//       <Card title="Document History" sub={`${total} total documents processed`}>
//         {/* Search */}
//         <div className="mb-4">
//           <input
//             type="text"
//             placeholder="Search by filename, document ID, or invoice number…"
//             value={search}
...
//               {search ? "No results match your search" : "No documents uploaded yet"}
//             </p>
//             <p className="text-xs mt-1">
//               {!search && "Use the Upload tab to process documents"}
//             </p>
//           </div>
//         ) : (
//           <div className="space-y-4">
...
//               <div
//                 key={doc.document_id}
//                 className="border border-gray-200 rounded-xl p-4 hover:border-blue-200 hover:bg-blue-50/30 transition"
//               >
...
//                       <span className="text-xs text-gray-400 ml-2">{doc.document_id}</span>
//                     </div>
...
//                           ? `$${fmt(doc.extracted_data.total_amount)}`
//                           : "—"}
//                       </p>
//                     </div>
//                     <div>
...
//                           doc.ocr_confidence >= 0.8
//                             ? "text-green-600"
//                             : doc.ocr_confidence >= 0.6
//                             ? "text-amber-600"
//                             : "text-red-600"
//                         }`}
//                       >
...
// // ── Helper Components ─────────────────────────────────────────────────────
// function ResultItem({ label, value, accent, small }) {
//   return (
//     <div>
...
//             : `text-lg ${accent ? "text-blue-600" : "text-gray-900"}`
//         }`}
//       >
//         {value || "—"}
//       </p>
...
//       {activeTab === "upload" && (
//         <UploadTab onUploaded={() => setRefreshKey((k) => k + 1)} />
//       )}
