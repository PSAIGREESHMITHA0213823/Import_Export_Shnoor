...
// //       setError("Please fill HSN code, product value and quantity."); return;
// //     }
// //     setLoading(true);
// //     try {
...
// //       <Card title="Duty & Tax Calculator" sub="Basic customs duty, IGST, anti-dumping & landed cost">
// //         <div className="grid grid-cols-2 gap-4 mb-4">
// //           <Field label="HSN Code">
// //             <input className="input" placeholder="e.g. 84713000" value={form.hsn_code} onChange={set("hsn_code")} />
// //           </Field>
// //           <Field label="Product value (USD per unit)">
// //             <input className="input" type="number" placeholder="1000" value={form.product_value} onChange={set("product_value")} />
// //           </Field>
// //         </div>

// //         <div className="grid grid-cols-3 gap-4 mb-4">
// //           <Field label="Quantity">
// //             <input className="input" type="number" placeholder="10" value={form.quantity} onChange={set("quantity")} />
// //           </Field>
...
// //             <input className="input" type="number" value={form.freight_cost} onChange={set("freight_cost")} />
// //           </Field>
// //           <Field label="Insurance cost (USD)">
// //             <input className="input" type="number" value={form.insurance_cost} onChange={set("insurance_cost")} />
// //           </Field>
// //         </div>
...
// //         {error && <p className="text-sm text-red-600 bg-red-50 border border-red-200 rounded-lg px-4 py-2 mt-4">{error}</p>}
// //       </Card>

// //       {result && (
// //         <Card title="Duty Breakdown">
// //           <div className="grid grid-cols-2 sm:grid-cols-4 gap-5">
// //             <DutyItem label="Assessable Value"         value={`$${fmt(result.assessable_value)}`}          />
// //             <DutyItem label="Basic Customs Duty"       value={`$${fmt(result.basic_customs_duty)}`}        />
// //             <DutyItem label="Anti-Dumping Duty"        value={`$${fmt(result.anti_dumping_duty)}`} warning />
// //             <DutyItem label="Social Welfare Surcharge" value={`$${fmt(result.social_welfare_surcharge)}`} />
// //             <DutyItem label="IGST"                     value={`$${fmt(result.igst)}`}                      />
// //             <DutyItem label="Total Duty"               value={`$${fmt(result.total_duty)}`}       danger   />
// //             <DutyItem label="Landed Cost"              value={`$${fmt(result.landed_cost)}`}      accent   />
// //             <DutyItem label="Effective Rate"           value={`${result.effective_rate_pct.toFixed(2)}%`} />
// //           </div>

// //           {/* Visual breakdown bar */}
// //           <div className="mt-6 pt-5 border-t border-gray-100">
// //             <p className="text-xs font-medium text-gray-400 mb-3 uppercase tracking-widest">Cost breakdown</p>
...
// // function DutyItem({ label, value, accent, danger, warning }) {
// //   const cls = accent ? "text-blue-600" : danger ? "text-red-600" : warning ? "text-amber-600" : "text-gray-900";
// //   return (
// //     <div>
...
// // ── Duty Result Display Component ─────────────────────────────────────────
// function DutyResult({ result }) {
...
//   return (
//     <Card title="Duty Calculation History" sub={`${total} total calculations`}>
//       {/* Search */}
//       <div className="mb-4">
//         <input
//           type="text"
//           placeholder="Search by HSN code or country…"
//           value={search}
...
//             {search ? "No results match your search" : "No duty calculations yet"}
//           </p>
//           <p className="text-xs mt-1">
//             {!search && "Use the Calculate tab to get started"}
//           </p>
//         </div>
//       ) : (
...
//                 <th className="text-left text-xs font-semibold text-gray-500 pb-3 pr-4">HSN Code</th>
//                 <th className="text-left text-xs font-semibold text-gray-500 pb-3 pr-4">Origin → Dest</th>
//                 <th className="text-left text-xs font-semibold text-gray-500 pb-3 pr-4">Qty</th>
//                 <th className="text-left text-xs font-semibold text-gray-500 pb-3 pr-4">Landed Cost</th>
...
//               {filtered.map((row, i) => (
//                 <tr
//                   key={row.calculation_id || i}
//                   className="border-b border-gray-50 hover:bg-gray-50 transition"
//                 >
//                   <td className="py-3 pr-4">
//                     <span className="font-mono text-blue-600 font-semibold bg-blue-50 px-2 py-0.5 rounded">
//                       {row.hsn_code}
//                     </span>
//                   </td>
...
//       {activeTab === "calculate" && (
//         <CalculatorTab onCalculated={() => setHistoryKey((k) => k + 1)} />
//       )}
