...
// // const SEED_USERS = [
// //   { username: "admin",     full_name: "Admin User",   email: "admin@tradelint.com",  company_name: "TradeLint",     role: "admin"    },
// //   { username: "demo",      full_name: "Demo User",    email: "demo@tradelint.com",   company_name: "Demo Corp",     role: "importer" },
// //   { username: "exporter1", full_name: "Priya Sharma", email: "exp@tradelint.com",    company_name: "Priya Exports", role: "exporter" },
// //   { username: "broker1",   full_name: "Arjun Singh",  email: "broker@tradelint.com", company_name: "Singh Brokers", role: "broker"   },
// // ];
...
// //   const [form, setForm]       = useState({ full_name:"", username:"", email:"", company_name:"", phone:"", password:"", role:"importer" });
...
// //     e.preventDefault();
// //     setError(""); setSuccess("");
// //     const { full_name, username, email, company_name, phone, password } = form;
// //     if (!full_name || !username || !email || !company_name || !phone || !password) {
// //       setError("Please fill in all fields."); return;
// //     }
// //     setLoading(true);
// //     try {
// //       const data = await api.register({ ...form });
// //       setUsers((prev) => [...prev, { username: form.username, full_name: form.full_name, email: form.email, company_name: form.company_name, role: form.role }]);
// //       setSuccess(`User "${form.username}" created successfully.`);
// //       setForm({ full_name:"", username:"", email:"", company_name:"", phone:"", password:"", role:"importer" });
// //     } catch (err) {
...
// //             {users.map((u) => (
// //               <div key={u.username} className="flex items-center gap-4 py-3 border-b border-gray-50 last:border-0">
...
// //                     {u.role}
// //                   </span>
// //                   <p className="text-xs text-gray-400 mt-1">{u.company_name}</p>
// //                 </div>
// //               </div>
// //             ))}
// //           </div>
...
// //       {/* Quick register */}
// //       <Card title="Quick Register" sub="Add a new user">
// //         <form onSubmit={addUser} className="space-y-3">
// //           <Field label="Full name">
// //             <input className="input" placeholder="Ravi Kumar" value={form.full_name} onChange={set("full_name")} />
// //           </Field>
// //           <Field label="Username">
// //             <input className="input" placeholder="ravi_kumar" value={form.username} onChange={set("username")} />
// //           </Field>
// //           <Field label="Email">
// //             <input className="input" type="email" placeholder="ravi@co.com" value={form.email} onChange={set("email")} />
// //           </Field>
// //           <Field label="Company">
// //             <input className="input" placeholder="Kumar Exports" value={form.company_name} onChange={set("company_name")} />
// //           </Field>
// //           <Field label="Phone">
...
// //             className="w-full py-2.5 bg-[#1a3a6b] text-white rounded-xl font-semibold hover:bg-blue-800 disabled:opacity-60 transition text-sm">
